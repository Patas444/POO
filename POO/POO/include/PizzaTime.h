...
//Aqui comenzaremos a crear las Pizzas
class 
Pizza {
public:

	void 
	//Aqui agregaremos nuevas partes/ingredientes
...
//En esta parte se crearan los ingredientes para nuestra Pizza
class Cook
{
public:
	virtual
...
//Desde aqui podremos crear las diferentes pizzas con sus respectivos ingredientes
...
//Aqui se podra crear una pizza con ingredientes especificos
class Chef {
public:
