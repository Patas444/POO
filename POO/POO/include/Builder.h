...
public:
	void
	//Aqui agregaremos nuevas partes
...
//En esta se crearan las partes del objeto
class Builder
{
public:
virtual
...
//Aqui se implementaran las partes del producto
...
//Aqui se realizara la contrucción del producto
class Director {
public:
